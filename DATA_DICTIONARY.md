...
| File | Records | Fields |
|------|---------|--------|
| fragrances.csv | 136,682 | 30 |
| brands.csv | 8,175 | 54 |
| perfumers.csv | 3,090 | 42 |
| notes.csv | 2,586 | 55 |
| accords.csv | 92 | 27 |
...
| url | URL | Fragrantika page | `https://www.fragrantica.com/perfume/Creed/Aventus-9828.html` |
