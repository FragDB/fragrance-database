...
| `url` | URL | Fragrantika brand page | `https://www.fragrantica.com/designers/Creed.html` |
...
##### url
- **Notes**: Absolute URL to brand's profile page on Fragrantika. May be empty for some brands.
...
| `url` | URL | Fragrantika perfumer page | `https://www.fragrantica.com/noses/Alberto_Morillas.html` |
...
##### url
- **Notes**: Absolute URL to perfumer's profile page on Fragrantika. May be empty.
